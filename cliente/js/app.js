...
function confirmarBuilder() {
    ...
    carrinho.push({
        ...
        // Canonical structured representation; legacy display fields remain for old readers.
        customPizza: {
            sizeId: pizzaBuilder.tamanho.id,
            flavorIds: pizzaBuilder.sabores.map(s => s.id),
            addOnIds: pizzaBuilder.adicionais.map(a => a.id)
        },
