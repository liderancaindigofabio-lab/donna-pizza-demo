...
(function (root) {
  ...
  root.NONNA_API = Object.freeze({
    ...
    publicOrder: order => request('/api/orders', { method: 'POST', body: JSON.stringify(order) }),
    ...
    update: (resource, id, data) => request('/api/' + encodeURIComponent(resource) + '/' + encodeURIComponent(id), { method: 'PATCH', body: JSON.stringify(data) }),
